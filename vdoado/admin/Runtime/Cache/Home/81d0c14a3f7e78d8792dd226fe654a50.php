    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo U('Home/Tch/lesson');?>" data-index="0">2016-10-15</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo U('Home/Tch/lesson');?>">2016-10-16</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo U('Home/Tch/lesson');?>">2016-10-17</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo U('Home/Tch/lesson');?>">2016-10-18</a>
                            </li>
                        </ul>

                    </li>
                    <li>
                        <a class="J_menuItem" href="<?php echo U('Home/Tch/new_lesson');?>">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?php echo U('Home/Tch/index_show');?>" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
