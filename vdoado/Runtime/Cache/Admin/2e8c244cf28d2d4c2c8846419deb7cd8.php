...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo U('Admin/Tch/lesson');?>" data-index="0">2016-10-15</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo U('Admin/Tch/lesson');?>">2016-10-16</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo U('Admin/Tch/lesson');?>">2016-10-17</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo U('Admin/Tch/lesson');?>">2016-10-18</a>
                            </li>
                        </ul>

                    </li>
                    <li>
                        <a class="J_menuItem" href="<?php echo U('Admin/Tch/new_lesson');?>">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?php echo U('Admin/Index/index_show');?>" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
    ...
    <script src="<?php echo (JS_URL); ?>hplus.min.js-v=4.0.0.js"></script>
    <script type="text/javascript" src="<?php echo (JS_URL); ?>contabs.min.js"></script>
