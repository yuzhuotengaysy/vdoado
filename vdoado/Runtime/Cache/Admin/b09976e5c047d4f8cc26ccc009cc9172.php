...
<head>
    ...
    <link href="<?php echo ($smarty["const"]["CSS_URL"]); ?>plugins/sweetalert/sweetalert.css" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <script src="<?php echo ($smarty["const"]["JS_URL"]); ?>plugins/sweetalert/sweetalert.min.js"></script>
</body>
