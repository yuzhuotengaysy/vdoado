<?php /* Smarty version Smarty-3.1.6, created on 2016-10-18 14:05:20
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5805bba0e6001',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5805bba0e6001')) {function content_5805bba0e6001($_smarty_tpl) {?><html>
...
jquery.min.js-v=2.1.4.js"></script>
      <script>
        $(document).ready(function(){
            ...
            var res = <?php echo json_encode($_smarty_tpl->tpl_vars['res']->value);?>
;
            for(key in res){
                $('#course').append('<li><a class="J_menuItem" href="<?php echo @__MODULE__;?>
/Tch/lesson/id/'+res[key]['course_id']+'" data-index="0">'+res[key]['course_pubtime']+'</a></li>');
